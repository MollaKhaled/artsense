...
const useAuctionSearchAndFilter = () => {
  ...
  // Fetch artists
  useEffect(() => {
    fetch(`${import.meta.env.VITE_BACKEND_URL}/auctionArtists`)
        .then(res => res.json())
        .then(data => {
  ...
  // Fetch media
  useEffect(() => {
    fetch(`${import.meta.env.VITE_BACKEND_URL}/auctionMedia`)
  ...
  // Fetch years
  useEffect(() => {
    fetch(`${import.meta.env.VITE_BACKEND_URL}/auctionYears`)
        .then(res => res.json())
        .then(data => {
  ...
  // Fetch prices
   useEffect(() => {
    fetch(`${import.meta.env.VITE_BACKEND_URL}/auctionPrices`)
        .then((res) => res.json())
        .then((data) => {
